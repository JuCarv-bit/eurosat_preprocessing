...
import os, sys
# assume this file lives in …/eurosat_preprocessing/new_architecture_simclr/simclr_eurosat.py
top = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))  
# now top points at …/eurosat_preprocessing/
...
from network import resnet18, projection_MLP
